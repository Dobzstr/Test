...
var dbConnectionString = builder.Configuration.GetConnectionString("TestDb");
var identityDbConnectionString = builder.Configuration.GetConnectionString("TestIdentityDb");
